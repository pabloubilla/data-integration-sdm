...
from src_old.load_data import build_paths_nceas, load_po_pa_nceas
...
from src_old.model_training import smooth_targets_v3

# --- your models & loss
from src_old.models import DeepMaxEntModel, DeepMaxEntLoss, DeepMaxEntPlotBias, deepmaxent_domain, grad_reverse, DomainDiscriminator, DeepMaxentTwoHead, SDMWithBias, deepmaxent_loss_w_bias, IntegratedLoss
